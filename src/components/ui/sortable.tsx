...
function Sortable<T>(props: SortableProps<T>) {
  ...
  const arrowDirectionText = useMemo(() => {
  ...
  const screenReaderInstructions: ScreenReaderInstructions = useMemo(
    () => ({
      draggable: `
        ...
        While dragging, use the ${arrowDirectionText} keys to move the item.
...
function SortableOverlay(props: SortableOverlayProps) {
  ...
  let overlayChildren: ReactNode = null;
  if (context.activeId !== null) {
    if (typeof children === "function") {
      overlayChildren = children({ value: context.activeId });
    } else {
